...
const Member = [
   ...
   {
      about: "I'm a junior software dev, serving in a non-profit religious organization coding with js, python and solidity. I run a local community (southern code) in Nigeria, teaching programming.",
      name: 'Oghenekparobo',
   ...
   {
      about: "I'm Junior developer from India, trying to learn and be comfortable with Javascript. Tech has always been my thing.",
      name: 'Deepak',
      speciality: 'Front-end Developer',
   ...
   {
      about: "Hi, I'm a Front End Developer from Tamil Nadu, India. Currently learning and working with React.",
      name: 'Sulthan',
      speciality: 'Front-End Developer',
      image: 'https://avatars.githubusercontent.com/u/32130871?v=4',
   ...
   {
      about: "Hello, I am Sagi. I am Computer Engineering Master's student who is interested in Web Development. Currently I am learning HTML,CSS and JavaScript",
      name: 'Sagi',
