const Member = [
  {
    about:
      "Hi, I'm Likii! 👋 Junior Developer Group founder and front-end developer working with Vue 💚 ",
    name: "Likii",
  ...
  {
    about:
      "I'm a junior SWE and ui designer from Costa Rica, currently learning front-end.",
    name: "Alejandro 🙋‍♂️",
  ...
  {
    about:
      "I'm a Computer Science student and have HTML, CSS, JS, BOOTSTRAP and a little NODE/EXPRESS under my belt.",
    name: "Lokesh",
    speciality: "Front-End Developer",
    image:
  ...
  {
    about:
      "I'm a junior front end developer from Tunisia, and i have passion to discover new technologies.",
    name: "Ilyes",
    speciality: "Front-End Developer",
    image:
