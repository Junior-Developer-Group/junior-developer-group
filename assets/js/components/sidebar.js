			...
			<navigation>
				<div class="d-flex flex-column p-3 text-white bg-dark" style="width: 280px; height: 100vh">
					<a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
						<img src="https://avatars.githubusercontent.com/u/77691813?v=4" class="bi me-2" width="40"
							height="32"></img>
						<span><span class="fs-4 w-100">JDG</span><span class="fs-6"> DEV Dashboard</span></span>
